...
class ProdutoDAO{
   ...
   public function listarCategoria(){
        ...
        try{
            $minhaConexao = Conexao::getConexao();
            //$sql = $minhaConexao->prepare("SELECT * FROM compracerta.produto LIMIT 9");
            $sql = $minhaConexao->prepare("SELECT * FROM compracerta.produto WHERE id_categoria = :id_categoria");
    ...
    public function mostrarProduto($prod){
      try{
        ...
        $minhaConexao = Conexao::getConexao();
        $sql = $minhaConexao->prepare("SELECT * FROM compracerta.produto WHERE id = :id");
    ...
    public function incluirProduto($prod){
       try{
           $minhaConexao = Conexao::getConexao();
           $sql = $minhaConexao->prepare("insert into compracerta.produto (nome, marca, descricao, preco) values (:nome, :edicao,:ano,:preco)");
